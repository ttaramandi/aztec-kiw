                                       ...
                                       void (*test_circuit_function)(UltraCircuitBuilder&, size_t)) noexcept
{
    ...
    mock_proofs::construct_proof_with_specified_num_iterations<plonk::UltraComposer>(
...
// Define benchmarks
BENCHMARK_CAPTURE(construct_proof_ultraplonk, sha256, &mock_proofs::generate_sha256_test_circuit<UltraCircuitBuilder>)
    ->Unit(kMillisecond);
BENCHMARK_CAPTURE(construct_proof_ultraplonk, keccak, &mock_proofs::generate_keccak_test_circuit<UltraCircuitBuilder>)
    ->Unit(kMillisecond);
