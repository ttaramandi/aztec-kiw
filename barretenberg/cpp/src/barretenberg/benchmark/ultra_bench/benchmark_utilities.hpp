...
{
    proof_system::stdlib::field_t a(proof_system::stdlib::witness_t(&builder, bb::fr::random_element()));
    proof_system::stdlib::field_t b(proof_system::stdlib::witness_t(&builder, bb::fr::random_element()));
