...
static void construct_proof_standard_power_of_2(State& state) noexcept
{
    ...
    mock_proofs::construct_proof_with_specified_num_iterations<plonk::StandardComposer>(
        state, &mock_proofs::generate_basic_arithmetic_circuit<StandardCircuitBuilder>, log2_of_gates);
}
