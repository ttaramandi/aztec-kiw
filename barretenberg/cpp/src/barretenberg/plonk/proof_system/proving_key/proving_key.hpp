...
struct proving_key_data {
    ...
    // PolynomialStoreWasm<fr> polynomial_store;
#else
...
struct proving_key {
  public:
    ...
    proving_key(proving_key_data&& data, std::shared_ptr<srs::factories::ProverCrs<curve::BN254>> const& crs);
    ...
    std::shared_ptr<srs::factories::ProverCrs<curve::BN254>> reference_string;

    polynomial quotient_polynomial_parts[plonk::NUM_QUOTIENT_PARTS];
