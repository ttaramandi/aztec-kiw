 ...
 */
template <const size_t num_roots_cut_out_of_vanishing_polynomial>
fr ProverPlookupWidget<num_roots_cut_out_of_vanishing_polynomial>::compute_quotient_contribution(
...
template class VerifierPlookupWidget<bb::fr, g1::affine_element, transcript::StandardTranscript>;
