...
struct join_split_tx {
    ...
    fr old_data_root;
    std::array<stdlib::merkle_tree::fr_hash_path, 2> input_path;
    ...
    stdlib::merkle_tree::fr_hash_path account_note_path;
    grumpkin::g1::affine_element signing_pub_key;

    fr backward_link;     // 0: no link, otherwise: any commitment.
