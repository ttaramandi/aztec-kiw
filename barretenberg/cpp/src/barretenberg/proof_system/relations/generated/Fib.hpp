  ...
  public:
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        // Contribution 0
        {
            ...
            auto tmp = (((-Fibonacci_LAST + FF(1)) * (Fibonacci_x_shift * (-Fib_LAST + FF(1)) - Fibonacci_y)) - FF(0));
            tmp *= scaling_factor;
            tmp *= (-Fib_FIRST + FF(1)); // Temp to switch off
            std::get<0>(evals) += tmp;
        }
        // Contribution 1
        {
            ...
            auto tmp =
                (((-Fibonacci_LAST + FF(1)) * (Fibonacci_y_shift * (-Fib_LAST + FF(1)) - (Fibonacci_x + Fibonacci_y))) -
                 FF(0));
            tmp *= scaling_factor;
            tmp *= (-Fib_FIRST + FF(1)); // Temp to switch off
            std::get<1>(evals) += tmp;
