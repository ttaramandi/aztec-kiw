...
template <typename G1> class ecc_generator_table {
  public:
     ...
     *equivalents)
     **/
    inline static std::array<std::pair<bb::fr, fr>, 256> generator_endo_xlo_table;
    inline static std::array<std::pair<bb::fr, fr>, 256> generator_endo_xhi_table;
    inline static std::array<std::pair<bb::fr, fr>, 256> generator_xlo_table;
    inline static std::array<std::pair<bb::fr, fr>, 256> generator_xhi_table;
    inline static std::array<std::pair<bb::fr, fr>, 256> generator_ylo_table;
    inline static std::array<std::pair<bb::fr, fr>, 256> generator_yhi_table;
    inline static std::array<std::pair<bb::fr, fr>, 256> generator_xyprime_table;
    inline static std::array<std::pair<bb::fr, fr>, 256> generator_endo_xyprime_table;
