...
inline std::array<fr, 2> get_xor_rotate_values_from_key(const std::array<uint64_t, 2> key)
{
...
{
    const uint64_t base = 1 << 6;
    constexpr bb::fr coefficient_16 = bb::fr(1) / fr(1 << 16);

    std::vector<fr> column_1_coefficients{
        bb::fr(1), bb::fr(1 << 6), fr(1 << 12), fr(1 << 18), fr(1 << 24), fr(1 << 30)
    };

    std::vector<fr> column_3_coefficients{ fr(1),
                                           fr(1 << 6),
                                           coefficient_16,
                                           coefficient_16 * fr(1 << 2),
                                           coefficient_16 * fr(1 << 8),
                                           coefficient_16 * fr(1 << 14) };
...
{
    const uint64_t base = 1 << 6;
    constexpr bb::fr coefficient_24 = bb::fr(1) / fr(1 << 24);
    ...
    std::vector<fr> column_3_coefficients{ fr(1),
                                           coefficient_24,
                                           coefficient_24 * fr(1 << 4),
                                           coefficient_24 * fr(1 << (4 + 6)),
                                           coefficient_24 * fr(1 << (4 + 12)),
                                           coefficient_24 * fr(1 << (4 + 18)) };
...
{
    const uint64_t base = 1 << 6;
    constexpr bb::fr coefficient_25 = bb::fr(1) / fr(1 << 25);
    ...
    std::vector<fr> column_3_coefficients{ fr(1),
                                           coefficient_25,
                                           coefficient_25 * fr(1 << 5),
                                           coefficient_25 * fr(1 << (5 + 6)),
                                           coefficient_25 * fr(1 << (5 + 12)),
                                           coefficient_25 * fr(1 << (5 + 18)) };
