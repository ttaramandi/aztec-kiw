...
ReadData<fr> get_lookup_accumulators(MultiTableId id,
                                     const fr& key_a,
                                     const fr& key_b = 0,
...
inline BasicTable create_basic_table(const BasicTableId id, const size_t index)
{
    ...
    case BN254_XLO_BASIC: {
        return ecc_generator_tables::ecc_generator_table<g1>::generate_xlo_table(BN254_XLO_BASIC, index);
    }
    case BN254_XHI_BASIC: {
        return ecc_generator_tables::ecc_generator_table<g1>::generate_xhi_table(BN254_XHI_BASIC, index);
    }
    case BN254_YLO_BASIC: {
        return ecc_generator_tables::ecc_generator_table<g1>::generate_ylo_table(BN254_YLO_BASIC, index);
    }
    case BN254_YHI_BASIC: {
        return ecc_generator_tables::ecc_generator_table<g1>::generate_yhi_table(BN254_YHI_BASIC, index);
    }
    case BN254_XYPRIME_BASIC: {
        return ecc_generator_tables::ecc_generator_table<g1>::generate_xyprime_table(BN254_XYPRIME_BASIC, index);
    }
    case BN254_XLO_ENDO_BASIC: {
        return ecc_generator_tables::ecc_generator_table<g1>::generate_xlo_endo_table(BN254_XLO_ENDO_BASIC, index);
    }
    case BN254_XHI_ENDO_BASIC: {
        return ecc_generator_tables::ecc_generator_table<g1>::generate_xhi_endo_table(BN254_XHI_ENDO_BASIC, index);
    }
    case BN254_XYPRIME_ENDO_BASIC: {
        return ecc_generator_tables::ecc_generator_table<g1>::generate_xyprime_endo_table(BN254_XYPRIME_ENDO_BASIC,
                                                                                          index);
    }
