...
void init_multi_tables()
{
    ...
    MULTI_TABLES[MultiTableId::BN254_XLO] = ecc_generator_tables::ecc_generator_table<g1>::get_xlo_table(
        MultiTableId::BN254_XLO, BasicTableId::BN254_XLO_BASIC);
    MULTI_TABLES[MultiTableId::BN254_XHI] = ecc_generator_tables::ecc_generator_table<g1>::get_xhi_table(
        MultiTableId::BN254_XHI, BasicTableId::BN254_XHI_BASIC);
    MULTI_TABLES[MultiTableId::BN254_YLO] = ecc_generator_tables::ecc_generator_table<g1>::get_ylo_table(
        MultiTableId::BN254_YLO, BasicTableId::BN254_YLO_BASIC);
    MULTI_TABLES[MultiTableId::BN254_YHI] = ecc_generator_tables::ecc_generator_table<g1>::get_yhi_table(
        MultiTableId::BN254_YHI, BasicTableId::BN254_YHI_BASIC);
    MULTI_TABLES[MultiTableId::BN254_XYPRIME] = ecc_generator_tables::ecc_generator_table<g1>::get_xyprime_table(
        MultiTableId::BN254_XYPRIME, BasicTableId::BN254_XYPRIME_BASIC);
    MULTI_TABLES[MultiTableId::BN254_XLO_ENDO] = ecc_generator_tables::ecc_generator_table<g1>::get_xlo_endo_table(
        MultiTableId::BN254_XLO_ENDO, BasicTableId::BN254_XLO_ENDO_BASIC);
    MULTI_TABLES[MultiTableId::BN254_XHI_ENDO] = ecc_generator_tables::ecc_generator_table<g1>::get_xhi_endo_table(
        MultiTableId::BN254_XHI_ENDO, BasicTableId::BN254_XHI_ENDO_BASIC);
    MULTI_TABLES[MultiTableId::BN254_XYPRIME_ENDO] =
        ecc_generator_tables::ecc_generator_table<g1>::get_xyprime_endo_table(MultiTableId::BN254_XYPRIME_ENDO,
                                                                              BasicTableId::BN254_XYPRIME_ENDO_BASIC);
...
ReadData<fr> get_lookup_accumulators(const MultiTableId id,
                                     const fr& key_a,
                                     const fr& key_b,
