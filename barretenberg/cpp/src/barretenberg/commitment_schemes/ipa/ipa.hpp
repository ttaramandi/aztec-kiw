  ...
  public:
                                      ...
                                      const std::shared_ptr<BaseTranscript>& transcript)
    {
        ...
        for (size_t i = 0; i < log_poly_degree; i++) {
            ...
            L_elements[i] = bb::pippenger_without_endomorphism_basis_points<Curve>(
                &a_vec[0], &G_vec_local[round_size], round_size, ck->pippenger_runtime_state);
            L_elements[i] += aux_generator * inner_prod_L;

            // R_i = < a_vec_hi, G_vec_lo > + inner_prod_R * aux_generator
            R_elements[i] = bb::pippenger_without_endomorphism_basis_points<Curve>(
                       ...
                       const std::shared_ptr<BaseTranscript>& transcript)
    {
        ...
        GroupElement LR_sums = bb::pippenger_without_endomorphism_basis_points<Curve>(
        ...
        auto G_zero = bb::pippenger_without_endomorphism_basis_points<Curve>(
