...
template <> inline std::shared_ptr<CommitmentKey<curve::BN254>> CreateCommitmentKey<CommitmentKey<curve::BN254>>()
{
    ...
    std::shared_ptr<srs::factories::CrsFactory<curve::BN254>> crs_factory(
        new srs::factories::FileCrsFactory<curve::BN254>("../srs_db/ignition", 4096));
...
{
    constexpr size_t n = 4096;
    std::shared_ptr<srs::factories::CrsFactory<curve::Grumpkin>> crs_factory(
        new srs::factories::FileCrsFactory<curve::Grumpkin>("../srs_db/grumpkin", 4096));
...
//     ::testing::Types<fake::Params<g1>, fake::Params<grumpkin::g1>, kzg::Params>;
