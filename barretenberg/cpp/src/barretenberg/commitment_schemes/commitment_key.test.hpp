...
template <> inline std::shared_ptr<CommitmentKey<curve::BN254>> CreateCommitmentKey<CommitmentKey<curve::BN254>>()
{
    ...
    std::shared_ptr<bb::srs::CrsFactory<curve::BN254>> crs_factory(
        new bb::srs::FileCrsFactory<curve::BN254>("../srs_db/ignition", 4096));
...
template <> inline std::shared_ptr<CommitmentKey<curve::Grumpkin>> CreateCommitmentKey<CommitmentKey<curve::Grumpkin>>()
{
    ...
    std::shared_ptr<bb::srs::CrsFactory<curve::Grumpkin>> crs_factory(
        new bb::srs::FileCrsFactory<curve::Grumpkin>("../srs_db/grumpkin", 4096));
