...
template <typename T> 
concept IsUltraFlavor = IsAnyOf<T, Ultra, GoblinUltra>;

template <typename T> 
concept IsGoblinFlavor = IsAnyOf<T, GoblinUltra,
                                    GoblinUltraRecursive>;

template <typename T> 
concept IsRecursiveFlavor = IsAnyOf<T, UltraRecursive_<UltraCircuitBuilder>, 
