  ...
  public:
    ...
    */
                                 ...
                                 const std::vector<FF>& gate_challenges)
    {
        ...
        PowPolynomial<FF> pow_univariate(gate_challenges);
...
template <typename Flavor> class SumcheckVerifier {
  ...
  public:
     ...
     * @param transcript
     */
    SumcheckOutput<Flavor> verify(const RelationParameters<FF>& relation_parameters,
                                  ...
                                  const std::vector<FF>& gate_challenges)
    {
        ...
        for (size_t round_idx = 0; round_idx < multivariate_d; round_idx++) {
            ...
            auto round_univariate =
                transcript->template receive_from_prover<Univariate<FF, BATCHED_RELATION_PARTIAL_LENGTH>>(
