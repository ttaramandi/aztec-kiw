  ...
  public:
    ...
    static Accumulator compute_read_term(const AllEntities& in, const Parameters& params)
    {
        ...
        if constexpr (Settings::READ_TERM_TYPES[read_index] == READ_BASIC_TUPLE) {
            ...
            constexpr_for<start_polynomial_index, start_polynomial_index + LOOKUP_TUPLE_SIZE, 1>(
            ...
            auto result = Accumulator(0);
            // Iterate over tuple and sum as a polynomial over beta
            constexpr_for<start_polynomial_index, start_polynomial_index + LOOKUP_TUPLE_SIZE, 1>([&]<size_t i>() {
