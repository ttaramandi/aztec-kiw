                                            ...
                                            uint8_t* output_sig_v)
{
    ...
    auto sig = crypto::ecdsa_construct_signature<Sha256Hasher, secp256k1::fq, secp256k1::fr, secp256k1::g1>(
                                                          ...
                                                          uint8_t* output_pub_key)
{
    ...
    auto recovered_pub_key =
        crypto::ecdsa_recover_public_key<Sha256Hasher, secp256k1::fq, secp256k1::fr, secp256k1::g1>(
                                         ...
                                         uint8_t const* sig_v)
{
    ...
    crypto::ecdsa_signature sig = { r, s, v };
    return crypto::ecdsa_verify_signature<Sha256Hasher, secp256k1::fq, secp256k1::fr, secp256k1::g1>(
