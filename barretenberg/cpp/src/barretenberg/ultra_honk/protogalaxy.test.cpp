...
template <typename Flavor> class ProtoGalaxyTests : public testing::Test {
  public:
    ...
    static ProverPolynomials construct_ultra_full_polynomials(auto& input_polynomials)
    {
    ...
    static std::shared_ptr<VerificationKey> construct_ultra_verification_key(size_t instance_size,
    ...
    static WitnessCommitments construct_witness_commitments()
    {
    ...
    static void test_full_protogalaxy()
    {
        ...
        GoblinMockCircuits::construct_goblin_ecc_op_circuit(builder_1);
        GoblinMockCircuits::construct_arithmetic_circuit(builder_1);

        auto instance_1 = composer.create_instance(builder_1);

        const size_t log_instance_size(5);
        const size_t instance_size(1 << log_instance_size);
        ...
        auto full_polynomials = construct_ultra_full_polynomials(random_polynomials);
        auto relation_parameters = bb::RelationParameters<FF>::get_random();
        typename Flavor::RelationSeparator alpha;
        for (auto& a : alpha) {
            a = FF::random_element();
        }
        ...
        // GoblinMockCircuits::construct_goblin_ecc_op_circuit(builder_2);
        // GoblinMockCircuits::construct_arithmetic_circuit(builder_2);

        // auto instance_2 = composer.create_instance(builder_2);

        auto instances = std::vector<std::shared_ptr<Instance>>{ accumulator, instance_1 };
        ...
        GoblinMockCircuits::construct_goblin_ecc_op_circuit(builder_3);
        GoblinMockCircuits::construct_arithmetic_circuit(builder_3);
...
using FlavorTypes = testing::Types<flavor::GoblinUltra>;
