...
namespace bb {
template <typename Tuple, std::size_t... Is> auto msgpack_drop_keys_impl(Tuple&& tuple, std::index_sequence<Is...>)
{
 ...
 */
template <typename... Args> auto msgpack_drop_keys(std::tuple<Args...>&& tuple)
{
    ...
    return msgpack_drop_keys_impl(tuple, compile_time_0_to_n_div_2);
}
} // namespace bb
