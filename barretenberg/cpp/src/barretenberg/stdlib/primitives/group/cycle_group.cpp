...
template class cycle_group<StandardCircuitBuilder>;
template class cycle_group<UltraCircuitBuilder>;
template class cycle_group<GoblinUltraCircuitBuilder>;
