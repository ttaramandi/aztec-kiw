...
template <typename Builder> class UintFuzzBase {
  private:
    ...
    typedef stdlib::uint<Builder, uint8_t> uint_8_t;
    typedef stdlib::uint<Builder, uint16_t> uint_16_t;
    typedef stdlib::uint<Builder, uint32_t> uint_32_t;
    typedef stdlib::uint<Builder, uint64_t> uint_64_t;
...
{
    using FuzzerClass = UintFuzzBase<StandardCircuitBuilder>;
