...
bigfield<Builder, T>::bigfield(Builder* parent_context)
    ...
    , binary_basis_limbs{ Limb(bb::fr(0)), Limb(bb::fr(0)), Limb(bb::fr(0)), Limb(fr(0)) }
...
bigfield<Builder, T>::bigfield(Builder* parent_context, const uint256_t& value)
    : context(parent_context)
    , binary_basis_limbs{ Limb(fr(value.slice(0, NUM_LIMB_BITS))),
                          Limb(fr(value.slice(NUM_LIMB_BITS, NUM_LIMB_BITS * 2))),
                          Limb(fr(value.slice(NUM_LIMB_BITS * 2, NUM_LIMB_BITS * 3))),
                          Limb(fr(value.slice(NUM_LIMB_BITS * 3, NUM_LIMB_BITS * 4))) }
                               ...
                               const size_t maximum_bitlength)
{
    ...
    if (low_bits_in.witness_index != IS_CONSTANT) {
        ...
        limb_0 = field_t(context, fr(slice_0));
        limb_1 = field_t(context, fr(slice_1));
    }
    ...
    if (high_bits_in.witness_index != IS_CONSTANT) {
        ...
        limb_2 = field_t(context, fr(slice_2));
        limb_3 = field_t(context, fr(slice_3));
    }
                                                                       ...
                                                                       const size_t maximum_bitlength)
{
    ...
    if constexpr (HasPlookup<Builder>) {
        ...
        limb_0.witness_index = ctx->add_variable(fr(limbs[0]));
        limb_1.witness_index = ctx->add_variable(fr(limbs[1]));
        limb_2.witness_index = ctx->add_variable(fr(limbs[2]));
        limb_3.witness_index = ctx->add_variable(fr(limbs[3]));
...
bigfield<Builder, T> bigfield<Builder, T>::operator+(const bigfield& other) const
{
    ...
    if constexpr (HasPlookup<Builder>) {
        if (prime_basis_limb.multiplicative_constant == 1 && other.prime_basis_limb.multiplicative_constant == 1 &&
            ...
            if (!limbconst) {
                std::pair<uint32_t, fr> x0{ binary_basis_limbs[0].element.witness_index,
                                            binary_basis_limbs[0].element.multiplicative_constant };
                std::pair<uint32_t, fr> x1{ binary_basis_limbs[1].element.witness_index,
                                            binary_basis_limbs[1].element.multiplicative_constant };
                std::pair<uint32_t, fr> x2{ binary_basis_limbs[2].element.witness_index,
                                            binary_basis_limbs[2].element.multiplicative_constant };
                std::pair<uint32_t, fr> x3{ binary_basis_limbs[3].element.witness_index,
                                            binary_basis_limbs[3].element.multiplicative_constant };
                std::pair<uint32_t, fr> y0{ other.binary_basis_limbs[0].element.witness_index,
                                            other.binary_basis_limbs[0].element.multiplicative_constant };
                std::pair<uint32_t, fr> y1{ other.binary_basis_limbs[1].element.witness_index,
                                            other.binary_basis_limbs[1].element.multiplicative_constant };
                std::pair<uint32_t, fr> y2{ other.binary_basis_limbs[2].element.witness_index,
                                            other.binary_basis_limbs[2].element.multiplicative_constant };
                std::pair<uint32_t, fr> y3{ other.binary_basis_limbs[3].element.witness_index,
                                            other.binary_basis_limbs[3].element.multiplicative_constant };
                fr c0(binary_basis_limbs[0].element.additive_constant +
                      other.binary_basis_limbs[0].element.additive_constant);
                fr c1(binary_basis_limbs[1].element.additive_constant +
                      other.binary_basis_limbs[1].element.additive_constant);
                fr c2(binary_basis_limbs[2].element.additive_constant +
                      other.binary_basis_limbs[2].element.additive_constant);
                fr c3(binary_basis_limbs[3].element.additive_constant +
                ...
                fr cp(prime_basis_limb.additive_constant + other.prime_basis_limb.additive_constant);
...
bigfield<Builder, T> bigfield<Builder, T>::operator-(const bigfield& other) const
{
     ...
     **/
    result.binary_basis_limbs[0].element = binary_basis_limbs[0].element + fr(to_add_0);
    result.binary_basis_limbs[1].element = binary_basis_limbs[1].element + fr(to_add_1);
    result.binary_basis_limbs[2].element = binary_basis_limbs[2].element + fr(to_add_2);
    result.binary_basis_limbs[3].element = binary_basis_limbs[3].element + fr(to_add_3);
    ...
    if constexpr (HasPlookup<Builder>) {
        if (prime_basis_limb.multiplicative_constant == 1 && other.prime_basis_limb.multiplicative_constant == 1 &&
            ...
            limbconst = limbconst || (prime_basis_limb.witness_index == other.prime_basis_limb.witness_index);
            if (!limbconst) {
                std::pair<uint32_t, fr> x0{ result.binary_basis_limbs[0].element.witness_index,
                                            binary_basis_limbs[0].element.multiplicative_constant };
                std::pair<uint32_t, fr> x1{ result.binary_basis_limbs[1].element.witness_index,
                                            binary_basis_limbs[1].element.multiplicative_constant };
                std::pair<uint32_t, fr> x2{ result.binary_basis_limbs[2].element.witness_index,
                                            binary_basis_limbs[2].element.multiplicative_constant };
                std::pair<uint32_t, fr> x3{ result.binary_basis_limbs[3].element.witness_index,
                                            binary_basis_limbs[3].element.multiplicative_constant };
                std::pair<uint32_t, fr> y0{ other.binary_basis_limbs[0].element.witness_index,
                                            other.binary_basis_limbs[0].element.multiplicative_constant };
                std::pair<uint32_t, fr> y1{ other.binary_basis_limbs[1].element.witness_index,
                ...
                std::pair<uint32_t, fr> y3{ other.binary_basis_limbs[3].element.witness_index,
                                            other.binary_basis_limbs[3].element.multiplicative_constant };
                fr c0(result.binary_basis_limbs[0].element.additive_constant -
                      other.binary_basis_limbs[0].element.additive_constant);
                fr c1(result.binary_basis_limbs[1].element.additive_constant -
                      other.binary_basis_limbs[1].element.additive_constant);
                fr c2(result.binary_basis_limbs[2].element.additive_constant -
                      other.binary_basis_limbs[2].element.additive_constant);
                fr c3(result.binary_basis_limbs[3].element.additive_constant -
                      other.binary_basis_limbs[3].element.additive_constant);
                ...
                cp += fr(constant_to_add_mod_p.lo);
     ...
     **/
    uint512_t constant_to_add_mod_p = (constant_to_add) % prime_basis.modulus;
    field_t prime_basis_to_add(ctx, fr(constant_to_add_mod_p.lo));
...
bigfield<Builder, T> bigfield<Builder, T>::conditional_negate(const bool_t<Builder>& predicate) const
{
    ...
    fr to_add_0(t0 + to_add_0_u256);
    fr to_add_1(t1 + to_add_1_u256);
    fr to_add_2(t2 + to_add_2_u256);
    fr to_add_3(to_add_3_u256 - t3);
...
template <typename Builder, typename T> void bigfield<Builder, T>::self_reduce() const
{
    ...
    uint32_t quotient_limb_index = context->add_variable(fr(quotient_value.lo));
                                                        ...
                                                        const std::vector<bigfield>& input_remainders)
{
    ...
    if constexpr (HasPlookup<Builder>) {
        ...
        non_native_field_witnesses<fr> witnesses{
            {
        ...
        fr neg_prime = -fr(uint256_t(target_basis.modulus));
        ...
        field_t<Builder> linear_terms(ctx, fr(0));
        if (to_add.size() >= 2) {
        ...
        const fr carry_lo_shift(uint256_t(uint256_t(1) << carry_lo_msb));
                                                                 ...
                                                                 const std::vector<bigfield>& input_remainders)
{
    ...
    if constexpr (HasPlookup<Builder>) {
        ...
        for (size_t i = 0; i < num_multiplications; ++i) {
            ...
            if (i > 0) {
                non_native_field_witnesses<fr> mul_witnesses = {
                    {
                                                      ...
                                                      const bigfield& remainder)
{
    ...
    field_t half(ctx, fr(2).invert());
    field_t two(ctx, fr(2));
