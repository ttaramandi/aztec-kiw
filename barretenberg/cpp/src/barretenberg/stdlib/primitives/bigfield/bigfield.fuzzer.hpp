...
template <typename Builder> class BigFieldBase {
  private:
    ...
    typedef stdlib::bigfield<Builder, Bn254FqParams> bigfield_t;
  ...
  public:
    ...
    class Instruction {
      public:
         ...
         */
        template <typename T>
        inline static bb::fq mutateFieldElement(fq e, T& rng, HavocSettings& havoc_config)
            requires SimpleRng<T>
        {
...
{
    using FuzzerClass = BigFieldBase<StandardCircuitBuilder>;
