...
template <typename Builder> class FieldBase {
  private:
    ...
    typedef stdlib::witness_t<Builder> witness_t;
  ...
  public:
    ...
    class Instruction {
      public:
         ...
         */
        template <typename T>
        inline static bb::fr mutateFieldElement(fr e, T& rng, HavocSettings& havoc_config)
            requires SimpleRng<T>
        {
      ...
      public:
        ...
        template <typename Instruction::OPCODE opcode> inline static Instruction parseInstructionArgs(uint8_t* Data)
        {
            if constexpr (opcode == Instruction::OPCODE::CONSTANT || opcode == Instruction::OPCODE::WITNESS ||
                ...
                instr.arguments.element = fr::serialize_from_buffer(Data);
                return instr;
            };
      ...
      public:
        ...
        ExecutionHandler set(Builder* builder)
        {
...
#endif
                return construct_via_cast<bb::fr>(fr::modulus - 1);
            case 6:
#if 1
                 ...
                 * StandardCircuitBuilder(); field_t a(witness_t(&builder,
            ...
            case 8: {
                ...
                switch (VarianceRNG.next() % 2) {
                case 0: {
                    const bb::fr field_from_bits = std::accumulate(frs.begin(), frs.end(), fr(0));
...
{
    using FuzzerClass = FieldBase<StandardCircuitBuilder>;
