...
template <ECCVMFlavor Flavor> class ECCVMComposer_ {
  public:
    ...
    std::shared_ptr<bb::srs::CrsFactory<typename Flavor::Curve>> crs_factory_;
    ...
    explicit ECCVMComposer_(std::shared_ptr<bb::srs::CrsFactory<typename Flavor::Curve>> crs_factory)
