...
void init_crs_factory(std::vector<bb::g1::affine_element> const& points, g2::affine_element const g2_point);

std::shared_ptr<srs::factories::CrsFactory<curve::BN254>> get_crs_factory();
std::shared_ptr<srs::factories::CrsFactory<curve::Grumpkin>> get_grumpkin_crs_factory();
