...
template <> class VerifierCrs<curve::BN254> {
  ...
  public:
     ...
     */
    virtual pairing::miller_lines const* get_precomputed_g2_lines() const = 0;
    /**
...
template <typename Curve> class CrsFactory {
  public:
    ...
    virtual std::shared_ptr<srs::factories::ProverCrs<Curve>> get_prover_crs(size_t) { return nullptr; }
    virtual std::shared_ptr<srs::factories::VerifierCrs<Curve>> get_verifier_crs([[maybe_unused]] size_t degree = 0)
    {
        return nullptr;
    }
};
