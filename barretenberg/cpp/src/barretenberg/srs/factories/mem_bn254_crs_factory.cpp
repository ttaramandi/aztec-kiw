  ...
  public:
    MemVerifierCrs(g2::affine_element const& g2_point)
        ...
        , precomputed_g2_lines(
              static_cast<pairing::miller_lines*>(aligned_alloc(64, sizeof(pairing::miller_lines) * 2)))
    {
...
std::shared_ptr<srs::factories::ProverCrs<curve::BN254>> MemBn254CrsFactory::get_prover_crs(size_t)
{
    return prover_crs_;
}

std::shared_ptr<srs::factories::VerifierCrs<curve::BN254>> MemBn254CrsFactory::get_verifier_crs(size_t)
{
