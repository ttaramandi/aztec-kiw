...
export interface PublicExecutor {
   ...
   * @param _execution - The execution to run.
   * @param _globalVariables - The global variables to use.
   * @returns The result of the run plus all nested runs.
   */
  simulate(_execution: PublicExecution, _globalVariables?: GlobalVariables): Promise<PublicExecutionResult>;
}
 ...
 * Handles execution of public functions.
 */
export class ACVMPublicExecutor implements PublicExecutor {
  constructor(
