...
import { EmitNoteHash, EmitNullifier, EmitUnencryptedLog, NullifierExists, SendL2ToL1Message } from './accrued_substate.js';
...
describe('Accrued Substate', () => {
  ...
  describe('NullifierExists', () => {
    it('Should (de)serialize correctly', () => {
      ...
      const inst = new NullifierExists(/*indirect=*/ 0x01, /*nullifierOffset=*/ 0x12345678, /*existsOffset=*/ 0x456789AB);
